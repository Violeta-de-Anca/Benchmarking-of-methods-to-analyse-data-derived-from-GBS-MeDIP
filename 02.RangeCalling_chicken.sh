...
#SBATCH --error /proj/naiss2024-23-57/GBS_MeDIP_benchmark/log_files/02.peak_analysis_chicken.err
#SBATCH --output /proj/naiss2024-23-57/GBS_MeDIP_benchmark/log_files/02.peak_analysis_chicken.out
#SBATCH --mail-type=FAIL,BEGIN
#SBATCH --mail-user=violeta.deancaprado@ebc.uu.se

###############
# Authors: Fabio Pertille & Violeta de Anca Prado;
# Description: Defining the regions of interest for DMR
...
on.exit(stopCluster(cl))  # Ensures that the cluster is stopped when the script exits
