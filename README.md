...
GBS-MeDIP is a cost-effective method developed to investigate DNA methylation. Due to its unique data characteristics, traditional pipelines for RNA-seq or MeDIP-seq analyses are not suitable. This repository provides validated scripts that optimize the analytical pipeline specifically for GBS-MeDIP data.
